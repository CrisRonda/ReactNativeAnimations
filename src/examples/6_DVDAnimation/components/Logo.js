...
// it is animated beacause the color will change
const AnimatedPath = Animated.createAnimatedComponent(Path);

export const LOGO_WIDTH = 187.09;
export const LOGO_HEIGHT = 82.68;
const Logo = ({color}) => {
  // processColor is a worklet to normalize color to number
  // in android because, Android use 32 bit *signed* integer to represent the color
